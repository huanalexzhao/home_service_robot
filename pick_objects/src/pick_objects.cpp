...
int main(int argc, char** argv){
  ...
  // Wait 5 seconds for the results
  ac.waitForResult();
  ...
  if(ac.getState() == actionlib::SimpleClientGoalState::SUCCEEDED)
    ...
    ROS_INFO("The base failed to get the pickup zone for some reason");
  ...
  if(ac.getState() == actionlib::SimpleClientGoalState::SUCCEEDED)
    ...
    ROS_INFO("The base failed to get the dropoff zone for some reason");
